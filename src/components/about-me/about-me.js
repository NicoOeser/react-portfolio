          ...
          <div className='about-me'>
            <div className='about-me-text' translate='yes'>
              ...
              <p>Now that I no longer find fulfilment in my current job, I remembered my childhood. I quickly realised that this was exactly where my future lay.
                So I started studying at the{' '}<a href='https://developerakademie.com/' target="_blank" rel="noreferrer" translate='no'>
                  Developer Academy
                </a>{' '}
                on part-time basis and discovered software development, in special front-end development.</p>
